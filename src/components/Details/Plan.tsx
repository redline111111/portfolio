...
export const Plan = ({select}:PlanItemProps) => {
    ...
    return(
        <>
            ...
            <div>
            <span className="font-bold">Сейчас: </span> <span className="text-indigo-700">Next.js</span>, <span className="text-rose-500">NestJS</span>. Для того, чтобы соответствовать современным требованиям рынка.
            </div>
            <br />
            <div>
                ...
                <br />
                Моя цель - узнать, как реализуются различные backend решения в других технологиях, а так же уметь продуктивно работать с продакшн проектами
            </div>
        </>
    )
};
